...
const logros = [
  {
    nombre: "Primera muerte de Ragnaros",
    fecha: "10/12/2023",
    por: "Thraxx y la raid",
  },
  ...
  {
    nombre: "Completar ZG en una noche",
    fecha: "01/02/2024",
    por: "Raid team 2",
  },
];
        ...
        <main className="max-w-7xl mx-auto px-2 sm:px-3 md:px-4 py-4 sm:py-6 md:py-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3 md:gap-4 mb-4 sm:mb-6 md:mb-8">
            <div className="bg-[#1a1f23]/80 border-2 border-[#8b6f4c] p-2 sm:p-3 md:p-6 text-center backdrop-blur-sm">
              <p className="text-base sm:text-lg md:text-3xl font-bold text-[#f0d9b5]">
                33/61
              </p>
              <p className="text-[8px] sm:text-[10px] md:text-xs text-[#8b6f4c] uppercase mt-0.5 sm:mt-1 md:mt-2">
                Jefes
              </p>
              <div className="w-full h-1 sm:h-1.5 md:h-2 bg-[#0a0c0e] mt-1 sm:mt-2 md:mt-3">
                <div
                  className="h-full bg-[#f0d9b5]"
                  style={{ width: "54%" }}
                ></div>
              </div>
            </div>
            ...
            <div className="bg-[#1a1f23]/80 border-2 border-[#8b6f4c] p-2 sm:p-3 md:p-6 text-center backdrop-blur-sm">
              ...
              <p className="text-[8px] sm:text-[10px] md:text-sm text-green-500 mt-0.5 sm:mt-1 md:mt-2">
                ✓ 2 prog
              </p>
            </div>
            ...
            <div className="bg-[#1a1f23]/80 border-2 border-[#8b6f4c] p-2 sm:p-3 md:p-6 text-center backdrop-blur-sm">
              ...
              <p className="text-[8px] sm:text-[10px] md:text-sm text-[#c4aa7d] mt-0.5 sm:mt-1 md:mt-2">
                73% éxito
              </p>
            </div>
            ...
            <div className="bg-[#1a1f23]/80 border-2 border-[#8b6f4c] p-2 sm:p-3 md:p-6 text-center backdrop-blur-sm">
              ...
              <p className="text-[8px] sm:text-[10px] md:text-sm text-yellow-500 mt-0.5 sm:mt-1 md:mt-2">
                ⚡ 2 TF
              </p>
            </div>
          </div>
              ...
              >
                ...
                <div className="relative h-20 sm:h-24 md:h-32 bg-gradient-to-r from-[#2a2f33]/80 to-[#1a1f23]/80 border-b-2 border-[#8b6f4c] p-2 sm:p-3 md:p-4">
                  <div
                    ...
                    style={{
                      backgroundImage:
                        "url('data:image/svg+xml,%3Csvg width='20' height='20' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%23c4aa7d' fill-opacity='0.1'%3E%3Cpath d='M0 0h20v20H0V0z'/%3E%3C/g%3E%3C/svg%3E')",
                    }}
                  ></div>
                ...
                <div className="p-2 sm:p-3 md:p-4">
                  ...
                  <div className="mb-2 sm:mb-3 md:mb-4">
                    <div className="flex justify-between text-[10px] sm:text-xs md:text-sm mb-0.5 sm:mb-1">
                      ...
                      <span className="text-[#f0d9b5] font-bold">
                        {raid.progreso}%
                      </span>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-2 sm:gap-3 md:gap-4 text-[10px] sm:text-xs md:text-sm mb-2 sm:mb-3 md:mb-4">
                    <div>
                      <p className="text-[#8b6f4c] text-[8px] sm:text-[10px] md:text-xs">
                        Último jefe
                      </p>
                      <p className="text-[#f0d9b5] text-[10px] sm:text-xs md:text-sm truncate">
                        {raid.ultimoJefe || "N/A"}
                      </p>
                    </div>
                    <div>
                      ...
                      <p className="text-[#f0d9b5] text-[10px] sm:text-xs md:text-sm">
                        {raid.ultimaDerrota || "Pendiente"}
                      </p>
                    </div>
                  </div>
                  ...
                  {/* Lista de jefes */}
                  <div className="mb-2 sm:mb-3 md:mb-4">
                    <p className="text-[#8b6f4c] text-[8px] sm:text-[10px] md:text-xs mb-1 sm:mb-1.5 md:mb-2">
                      JEFES
                    </p>
                    <div className="flex flex-wrap gap-0.5 sm:gap-1">
                      {Array.from({ length: raid.jefesDerrotados }).map(
                        (_, i) => (
                          <span
                            key={i}
                            className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 bg-green-900/80 border border-green-700 flex items-center justify-center text-[8px] sm:text-[10px] md:text-xs text-green-300"
                          >
                            ✓
                          </span>
                        ),
                      ...
                      {Array.from({
                        length: raid.jefes - raid.jefesDerrotados,
                      }).map((_, i) => (
                        <span
                          key={i}
                          className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 bg-[#0a0c0e]/80 border border-[#8b6f4c] flex items-center justify-center text-[8px] sm:text-[10px] md:text-xs text-[#4a3a28]"
                        >
                          ?
                        </span>
                      ))}
                      ...
                      <div className="flex flex-col sm:flex-row gap-1 sm:gap-2 md:gap-3">
                        {raid.loot.map((item, index) => (
                          ...
                          >
                            ...
                            <span className="text-[#8b6f4c] ml-0.5 sm:ml-1">
                              ({item.dropRate}%)
                            </span>
                          </div>
                        ))}
              ...
              {logros.map((logro, index) => (
                <div
                  ...
                  className={`p-2 sm:p-3 md:p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-1 sm:gap-2 ${
                    index !== logros.length - 1
                      ? "border-b border-[#8b6f4c]"
                      : ""
                  } hover:bg-[#2a2f33] transition-colors`}
                >
                  <div className="flex items-center space-x-2 sm:space-x-3 md:space-x-4">
                    <span className="text-base sm:text-lg md:text-2xl text-yellow-500">
                      🏆
                    </span>
                    <div>
                      <p className="text-xs sm:text-sm md:text-base text-[#f0d9b5] font-bold">
                        {logro.nombre}
                      </p>
                      <p className="text-[8px] sm:text-[10px] md:text-xs text-[#8b6f4c]">
                        Por: {logro.por}
                      </p>
                    </div>
                  </div>
                  <span className="text-[8px] sm:text-[10px] md:text-sm text-[#8b6f4c] sm:text-right ml-6 sm:ml-0">
                    {logro.fecha}
                  </span>
                </div>
              ))}
          ...
          <section className="mt-6 sm:mt-8 md:mt-12">
            <div className="bg-gradient-to-r from-[#1a1f23]/80 to-[#0a0c0e]/80 border-2 border-[#8b6f4c] p-3 sm:p-4 md:p-6 backdrop-blur-sm">
              <h3 className="text-base sm:text-lg md:text-xl font-bold text-[#f0d9b5] mb-2 sm:mb-3 md:mb-4 flex items-center">
                <span className="text-lg sm:text-xl md:text-2xl mr-1 sm:mr-2">
                  🎯
                </span>
                OBJETIVOS
              </h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 sm:gap-3 md:gap-4">
                <div className="bg-[#0a0c0e]/80 p-2 sm:p-3 md:p-4 border border-[#8b6f4c] backdrop-blur-sm">
                  ...
                  <p className="text-[8px] sm:text-[10px] md:text-xs text-[#8b6f4c] mt-0.5 sm:mt-1">
                    BWL - 80%
                  </p>
