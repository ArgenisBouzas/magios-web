    ...
    <div className="min-h-screen bg-[#0a0c0e] text-[#c4aa7d]">
      ...
      <main className="max-w-7xl mx-auto px-2 sm:px-3 md:px-4 py-4 sm:py-6 md:py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3 md:gap-4 mb-4 sm:mb-6 md:mb-8">
          <div className="bg-[#1a1f23] border-2 border-[#8b6f4c] p-2 sm:p-3 md:p-6 text-center">
        ...
        <div className="bg-[#1a1f23] border-2 border-[#8b6f4c] p-2 sm:p-3 md:p-4 mb-4 sm:mb-6 md:mb-8">
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 items-start sm:items-center justify-between">
            ...
            <div className="flex gap-2 w-full sm:w-auto">
              ...
              <button className="border border-[#8b6f4c] text-[#c4aa7d] px-2 sm:px-3 md:px-4 py-1 sm:py-1.5 md:py-2 text-[10px] sm:text-xs md:text-sm hover:bg-[#2a2f33] transition-colors flex-1 sm:flex-initial">
                ESTADÍSTICAS
              </button>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4 md:gap-6 mb-8 sm:mb-10 md:mb-12">
          {raids.map((raid) => (
            ...
            >
              {/* Cabecera de la raid */}
              <div className="relative h-20 sm:h-24 md:h-32 bg-gradient-to-r from-[#2a2f33] to-[#1a1f23] border-b-2 border-[#8b6f4c] p-2 sm:p-3 md:p-4">
                <div className="absolute inset-0 opacity-10" style={{
              ...
              <div className="p-2 sm:p-3 md:p-4">
                ...
                <div className="mb-2 sm:mb-3 md:mb-4">
                  ...
                  <div className="w-full h-2 sm:h-3 md:h-4 bg-[#0a0c0e] border border-[#8b6f4c] overflow-hidden">
                    <div 
                      className={`h-full ${
                ...
                <div className="mb-2 sm:mb-3 md:mb-4">
                  ...
                  <div className="flex flex-wrap gap-0.5 sm:gap-1">
                    {Array.from({ length: raid.jefesDerrotados }).map((_, i) => (
                      <span key={i} className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 bg-green-900 border border-green-700 flex items-center justify-center text-[8px] sm:text-[10px] md:text-xs text-green-300">
                        ✓
                      </span>
                    ))}
                    {Array.from({ length: raid.jefes - raid.jefesDerrotados }).map((_, i) => (
                      <span key={i} className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 bg-[#0a0c0e] border border-[#8b6f4c] flex items-center justify-center text-[8px] sm:text-[10px] md:text-xs text-[#4a3a28]">
                        ?
                      </span>
                    ))}
                  </div>
        ...
        <section className="mt-6 sm:mt-8 md:mt-12">
          <div className="bg-gradient-to-r from-[#1a1f23] to-[#0a0c0e] border-2 border-[#8b6f4c] p-3 sm:p-4 md:p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 sm:gap-3 md:gap-4">
              <div className="bg-[#0a0c0e] p-2 sm:p-3 md:p-4 border border-[#8b6f4c]">
              ...
              <div className="bg-[#0a0c0e] p-2 sm:p-3 md:p-4 border border-[#8b6f4c] sm:col-span-2 md:col-span-1">
