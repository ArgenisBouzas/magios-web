      ...
      <main className="max-w-7xl mx-auto px-2 sm:px-3 md:px-4 py-4 sm:py-6 md:py-12">
        ...
        {noticias.filter(n => n.destacada)[0] && (
          <div className="mb-6 sm:mb-8 md:mb-12 relative">
            ...
            <div className="bg-gradient-to-r from-[#1a1f23] to-[#2a2f33] border-2 border-[#8b6f4c] p-3 sm:p-4 md:p-6 pt-4 sm:pt-6 md:pt-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6 mb-8 sm:mb-10 md:mb-12">
          {noticias.map((noticia) => (
            ...
            >
              ...
              <div className="relative h-28 sm:h-32 md:h-40 bg-gradient-to-br from-[#2a2f33] to-[#1a1f23] border-b-2 border-[#8b6f4c]">
        ...
        <div className="mt-8 sm:mt-12 md:mt-16 bg-gradient-to-r from-[#1a1f23] to-[#0a0c0e] border-2 border-[#8b6f4c] p-3 sm:p-4 md:p-8">
          ...
          <div className="flex flex-col sm:flex-row max-w-md mx-auto gap-2 sm:gap-0">
            <input 
              ...
              className="flex-1 bg-[#0a0c0e] border-2 border-[#8b6f4c] sm:border-r-0 px-3 sm:px-4 py-2 sm:py-3 text-xs sm:text-sm text-[#f0d9b5] placeholder-[#4a3a28] focus:outline-none focus:border-[#f0d9b5]"
            />
